    ...
    public class SeedData
    {
        ...
        private static void EnsureUsers(IServiceScope scope)
        {
            ...
            if (angella == null)
            {
                ...
                var aux = new Claim[] {     
                            new Claim(JwtClaimTypes.Name, "Angela Freeman"),
                            new Claim(JwtClaimTypes.GivenName,"Angela"),
                            new Claim(JwtClaimTypes.FamilyName, "Freeman"),
                            new Claim(JwtClaimTypes.WebSite, "http://angelafreeman.com"),
                ...
                //result = userMgr.AddClaimsAsync(angella, new Claim[] { new Claim(JwtClaimTypes.Name, "Angela Freeman"), new Claim(JwtClaimTypes.GivenName, "Angela") }).Result;
                if (!result.Succeeded)
                {
                    throw new Exception(result.Errors.First().Description);
                }
